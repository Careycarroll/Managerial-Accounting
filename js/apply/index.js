...
const SCENARIOS = [
  {
    ...
    href: `${BASE}pages/apply/breakeven.html`,
    status: "available",
  ...
  },
  {
    ...
    href: `${BASE}pages/apply/product-cost.html`,
    status: "available",
  ...
  },
  {
    ...
    href: `${BASE}pages/apply/annual-plan.html`,
    status: "available",
    depths: { concept: true, analysis: true, simulation: false },
  },
  {
    ...
    href: `${BASE}pages/apply/variance.html`,
    status: "available",
    depths: { concept: true, analysis: true, simulation: false },
  },
  {
    ...
    chapterLabels: [
      ...
      "Ch. 5 ABC",
      "Ch. 10 Cost Behavior",
      "Ch. 23 Transfer Pricing",
    ],
    href: `${BASE}pages/apply/make-or-buy.html`,
    status: "available",
    depths: { concept: true, analysis: true, simulation: false },
  },
  {
    ...
    href: `${BASE}pages/apply/pricing.html`,
    status: "available",
    depths: { concept: true, analysis: true, simulation: false },
  },
  {
    ...
    href: `${BASE}pages/apply/customer-profit.html`,
    status: "available",
    depths: { concept: true, analysis: true, simulation: false },
  },
  {
    ...
    chapters: [21, 9, 12],
    chapterLabels: [
      "Ch. 21 Inventory Mgmt",
      "Ch. 9 Inventory Costing",
      "Ch. 12 Relevant Costs",
    ],
    href: `${BASE}pages/apply/inventory.html`,
    status: "available",
    depths: { concept: true, analysis: true, simulation: false },
  },
  {
    ...
    href: `${BASE}pages/apply/investment.html`,
    status: "available",
    depths: { concept: true, analysis: true, simulation: false },
  },
  {
    ...
    href: `${BASE}pages/apply/performance.html`,
    status: "available",
    depths: { concept: true, analysis: true, simulation: false },
  },
  {
    ...
    href: `${BASE}pages/apply/cost-behavior.html`,
    status: "available",
    depths: { concept: true, analysis: true, simulation: false },
  },
  {
    ...
    href: `${BASE}pages/apply/quality.html`,
    status: "available",
    depths: { concept: true, analysis: true, simulation: false },
  },
];

// Maps objective value -> display label, color token, bg token, and icon
...
function objectiveBadge(objective) {
  const meta = OBJECTIVE_META[objective] || OBJECTIVE_META.profit;
  return (
    '<span style="' +
...
function depthBadge(label, color, active) {
  return (
    '<span style="display:inline-flex;align-items:center;gap:4px;font-size:0.65rem;font-weight:600;padding:2px 8px;border-radius:9999px;' +
    (active
...
function renderScenarios() {
  ...
  grid.innerHTML = SCENARIOS.map((s) => {
    ...
    const chapterBadges = s.chapterLabels
      .map(
        (l) =>
          '<span style="font-size:0.65rem;font-weight:500;padding:2px 8px;background:var(--color-gray-100);color:var(--color-text-muted);border-radius:9999px;white-space:nowrap;">' +
          l +
          "</span>",
      )
      .join("");
    ...
    return (
      ...
      (available ? "cursor:pointer;" : "opacity:0.6;cursor:default;") +
      '" ' +
      ...
      objectiveBadge(s.objective) +
      (available
        ? '<span style="font-size:0.65rem;font-weight:700;color:var(--color-success);background:var(--color-success-bg);padding:2px 8px;border-radius:9999px;">Available</span>'
      ...
      (available
        ? '<span class="chapter-card__cta">Start &rarr;</span>'
        : '<span style="font-size:var(--font-size-xs);color:var(--color-gray-400);">Not yet available</span>') +
      "</div>" +
      "</div>"
    );
  }).join("");
